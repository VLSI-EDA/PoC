...
(latest 'master' branch), cloned with ``git clone`` or embedded with ``git submodule add``
from GitHub. GitHub offers HTTPS and SSH as transfer protocols. See the :doc:`Download` page for further details.
...
See the :doc:`Requirements` page for further details.
...
directory. See the :doc:`Third-Party </WhatIsPoC/ThirdParty>` page for more details on these libraries.
...
versions. See the :doc:`Configuration Details <Configuration>` page for more
details.
