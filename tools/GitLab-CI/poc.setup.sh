...
cp ./tools/GitLab-CI/config.private.ini ./.pyIPCMI
ExitIfError $? "${RED}Copying of ./tools/GitLab-CI/config.private.ini [FAILED]${NOCOLOR}"

echo -e "${CYAN}Copy my_project.vhdl into ./tb/common directory${NOCOLOR}"
cp ./tools/GitLab-CI/my_project.vhdl ./tb/common
ExitIfError $? "${RED}Copying of ./tools/GitLab-CI/my_project.vhdl [FAILED]${NOCOLOR}"
...
cp ./tools/GitLab-CI/modelsim.ini ./temp/precompiled/vsim
ExitIfError $? "${RED}Copying of ./tools/GitLab-CI/modelsim.ini [FAILED]${NOCOLOR}"
