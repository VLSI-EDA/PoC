...
Write-Host "git config --global alias.tree 'log --decorate --pretty=oneline --abbrev-commit --date-order --graph'"
git config --global alias.tree 'log --decorate --pretty=oneline --abbrev-commit --date-order --graph'

Write-Host "git config --global alias.treea 'log --decorate --pretty=oneline --abbrev-commit --date-order --graph' --all"
