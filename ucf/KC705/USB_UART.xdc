...
set_property PACKAGE_PIN	K23				[get_ports KC705_USB_UART_RTS_n]
## {OUT}		U34.22 {IN}		Clear to Send (FPGA is able to receive data)
set_property PACKAGE_PIN	L27				[get_ports KC705_USB_UART_CTS_n]
# set I/O standard
...
set_false_path								-from	[get_ports KC705_USB_UART_RTS_n]
set_false_path								-to		[get_ports KC705_USB_UART_CTS_n]
